...
def test_choose_ai_move_easy_returns_random_choice(monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("src.features.ai_games.ai_move_selector.random.choice", choose)
...
def test_choose_ai_move_medium_prefers_immediate_winning_move(
    ...
    monkeypatch.setattr(
        "src.features.ai_games.ai_move_selector.get_countries",
        lambda: {
            "AA": {"borders": ["BB", "CC"]},
            "BB": {"borders": ["AA"]},
            "CC": {"borders": ["AA", "DD"]},
    ...
    monkeypatch.setattr(
        "src.features.ai_games.ai_move_selector.random.choice",
...
def test_choose_ai_move_raises_when_no_available_moves(
    ...
    monkeypatch.setattr(
        "src.features.ai_games.ai_move_selector.get_countries", lambda: {"AA": {"borders": []}}
    )
